...
#define BENTO_LOCATION "http://static.opensuse.org/themes/bento/"
                       ...
                       void *output_arg[])
{
  ...
  fprintf(html,
          "        <a id=\"header-logo\" href=\"http://en.opensuse.org\"><img src=\""
  ...
  fprintf(html,
          ...
          "http://opensuse.org/sitemap#downloads\">Downloads</a></li>\n");
  fprintf(html,
          "          <li id=\"item-support\"><a href=\""
          "http://opensuse.org/sitemap#support\">Support</a></li>\n");
  fprintf(html,
          "          <li id=\"item-community\"><a href=\""
          "http://opensuse.org/sitemap#community\">Community</a></li>\n");
  fprintf(html,
          "          <li id=\"item-development\"><a href=\""
          "http://opensuse.org/sitemap#development\">Development</a></li>\n");
  fprintf(html,
          "        </ul>\n");
  fprintf(html,
          "      </div>\n");
  ...
  fprintf(html, 
          "        <a href=\"http://fontinfo.opensuse.org\" title=\"\"><img src=\""
  ...
  {
    fprintf(html, 
            "        Generated by fontinfo %s, fontconfig %s"
            " libpng %s, freetype %s"
                                           ...
                                           void *output_arg[])
{
  ...
  for (f = 0; f < fontset->nfont; f++)
  {
    ...
    specimen_sentence(config, charset, config.minispecimen_script,
                      &dir, &lang, &random, ucs4_sentence, SENTENCE_NCHARS);
                              ...
                              void *output_arg[])
{
  ...
  for (v = 0; v < nsignificantscripts; v++)
  {
    ...
    specimen_sentence(config, charset, scripts[v], 
                      &dir, &language, &random, ucs4_sentence, 
                      SENTENCE_NCHARS);
    ...
    write_specimen(html, pattern, FONTS_SUBDIR, 
                   ...
                   scripts[v] ? scripts[v] : "Random", language, dir, 
                   "              ", "specimenimgmap",
                   SPECIMEN_WIDTH_MAX);
    fprintf(html, 
            "            </td></tr></table>\n");
